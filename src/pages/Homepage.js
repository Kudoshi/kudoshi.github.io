...
function Homepage() {
  return (
    <div className="App container-fluid m-0 p-0">
      <div className='d-md-flex justify-content-center align-items-center p-5 BGBrandColor text-brand2'>
      ...
      <div className='BGBrandColor d-flex justify-content-center align-items-center py-3'>
        <br/>
