    ...
    return (
        <div className="bg-dark row py-2 container-fluid" style={{margin:"0px"}}>
            ...
            <div className="col-12 col-md-4 d-flex justify-content-center text-white py-2">
                <Link to="/Kudoshi-website/" className="un-underline text-white px-2">Homepage</Link> | 
                <Link to="/Kudoshi-website/project" className="un-underline text-white px-2">Project</Link> 
            </div>
